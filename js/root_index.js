...
async function showChapter(chapNum) {
    ...
    if (chapters[chapNum]) {
        ...
        try {
            ...
            for (let verseNum = 1; verseNum <= chapters[chapNum].verses; verseNum++) {
                ...
                // English Translation
                const englishText = englishTranslations[chapNum] && englishTranslations[chapNum][verseNum] || 'Translation not available';
                ...
                const indonesianText = indonesianTranslations[chapNum] && indonesianTranslations[chapNum][verseNum] || 'Translation not available';
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Initialize image size adjustment
        adjustImageSize();

        // Handle sidebar visibility based on screen size and saved preference
        ...
        if (window.innerWidth < 768) {
            ...
            if (sidebarHidden === 'true') {
                ...
                sidebar.style.display = 'block'; // default block
                mainContent.style.width = '100%'; // 75
            }

            // Handle chapter selection to hide sidebar and adjust main content
            ...
            // Desktop view
            sidebar.style.display = 'none';
            mainContent.style.width = '100%'; // default 75
